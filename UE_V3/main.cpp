...
int main()
{
    ...
    std::vector<Data_Point> user_location = read_tsv((char *)"test-25k.txt");
    //std::vector<Data_Point> user_location = read_tsv((char *)"/Users/emjaidi/Documents/Collegeish/Fall/CAHSI LREU/dataset_tsmc2014/dataset_TSMC2014_TKY.txt");
    ...
    std::vector<std::vector<int>> analyzed_query_values; //Store the values of the query x.[0] stores the og 
                                                            // x.[1] stores the est
    std::vector<int> og_generation { }, est_generation { }; // Used to split the analyzed query value nested vector 
    srand(time(nullptr));
